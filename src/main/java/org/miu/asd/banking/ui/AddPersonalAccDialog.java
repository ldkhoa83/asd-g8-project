...
{
	private AddPersonalAccountUICommand addPersonalAccountUICommand;
	private FrameTemplate parentframe;
    
	public JDialog_AddPAcc(FrameTemplate parent)
	{
		super(parent);
		parentframe=parent;
		addPersonalAccountUICommand = new AddPersonalAccountUICommand(parent.getAccountService());
