...
public class AddPersonalAccDialog extends JDialog
{
	private UICommand<BankAccountService> addPersonalAccountUICommand;

	public AddPersonalAccDialog(FrameTemplate parent, BankAccountService accountService)
	{
		super(parent);
		addPersonalAccountUICommand = new AddPersonalAccountUICommand(accountService);
